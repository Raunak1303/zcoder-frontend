...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setLoading(true)
      const res = await fetch('https://zcoder-backend-9aq1.onrender.com/api/auth/register', {
        method: 'POST',
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-zinc-950 via-zinc-900 to-black text-white px-4 py-16">
      <div className="flex flex-col items-center space-y-8 max-w-md w-full">
        ...
        >
          <h1 className="whitespace-nowrap text-5xl font-extrabold bg-gradient-to-r from-rose-500 to-indigo-400 text-transparent bg-clip-text">
            Welcome to ZCoder
          </h1>
        ...
        >
          <h1 className="text-4xl font-bold text-center bg-gradient-to-r from-rose-500 to-indigo-400 text-transparent bg-clip-text leading-tight mb-6">
            Register
          </h1>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 rounded-xl bg-gradient-to-r from-rose-500 to-indigo-500 font-semibold hover:opacity-90 transition duration-300"
          >
